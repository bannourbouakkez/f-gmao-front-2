...
/*
  ...
  Magasin:any={ label: 'Magasin', toggle: 'close', iconType: 'letter', iconName: 'M', submenu: [] };
      ...
      Magasin_Article={ label: 'Articles', iconType: 'letter', iconName: 'Art',
       submenu: [
      ...
      Magasin_Outillage={ label: 'Outillage', iconType: 'letter', iconName: 'Out', 
       submenu: [
  ...
  Preventif:any={ label: 'Preventif', toggle: 'close', iconType: 'letter', iconName: 'P', submenu: [] }
     Preventif_Intervention={ label: 'Intervention', iconType: 'letter', iconName: 'I',
      submenu: [
